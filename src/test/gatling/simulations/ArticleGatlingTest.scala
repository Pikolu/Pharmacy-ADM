...
class ArticleGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Article entity")
        ...
        .repeat(2) {
            ...
            .post("/api/articles")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "name":"SAMPLE_TEXT", "description":"SAMPLE_TEXT", "articelNumber":"0", "imageURL":"SAMPLE_TEXT", "deepLink":"SAMPLE_TEXT", "keyWords":"SAMPLE_TEXT"}""")).asJSON
            .check(status.is(201))
